...
def model_sampling(model_config):
...
class BaseModel(torch.nn.Module):
    def __init__(self, model_config, device=None, unet_model=UNetModel):
        super().__init__()
        ...
        self.model_sampling = model_sampling(model_config)
...
class WAN21(BaseModel):
    def __init__(self, model_config, image_to_video=False, device=None):
        super().__init__(model_config, device=device, unet_model=comfy.ldm.wan.model.WanModel)
...
class WAN22(WAN21):
    def __init__(self, model_config, image_to_video=False, device=None):
        super(WAN21, self).__init__(model_config, device=device, unet_model=comfy.ldm.wan.model.WanModel)
        self.image_to_video = image_to_video
